...
class setup_colors_frame(Frame, theme_provider):
    """
    ...
    def __init__(self, master: Union[Tk, Frame]) -> None:
        ...
        self.label = Label(self, text = "COLORS Setup", font = ("Arial", 60, "bold"), bg= self.frame_colour).pack(fill="none", expand=True)