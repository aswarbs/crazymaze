...
return_request["maze_data"] = maze
return_request["player_one_start"] = p1
return_request["player_two_start"] = p2
return_request["goal"] = goal

return_queue.put(return_request)
